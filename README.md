# RIVE — Blue Book V1 (révision v1.3)
...
- 📄 [**Brief exécutif (1 page)**](./EXEC_BRIEF.md) — 2 min, pour ministre / président d’EPCI / décideur.
- 📑 [**Dossier politique court (5 pages)**](./DOSSIER_POLITIQUE.md) — 15 min, pour cabinet / DGS / chef de bureau.
- 📚 **Blue Book complet** (`00_index.md`, 27 chapitres) — référence opérationnelle complète.

## Principe

- Un fichier Markdown par chapitre.
- La version courante est **v1.3** (juin 2026).
- Le fichier `00_index.md` sert de table de navigation.
- Le fichier `CHANGELOG.md` trace les évolutions.

## Structure

### Corps doctrinal (V1, révisé en v1.3)

- `00_avant_propos.md` — Avant-propos
- `01_resume_executif.md` — Résumé exécutif
- `02_le_nom_rive_et_son_architecture_institutionnelle.md` — Le nom RIVE et son architecture institutionnelle
- `03_principes_non_negociables.md` — Principes non négociables
...
- `14_si_donnees_et_llm.md` — SI, données et LLM
- `15_budget_et_financement.md` — Budget et financement
- `16_evaluation_independante.md` — Évaluation indépendante
- `17_risques_majeurs.md` — Risques majeurs
- `18_feuille_de_route.md` — Feuille de route
- `19_annexes_operationnelles_integrees.md` — Annexes opérationnelles intégrées
...
### Chapitres d’instruction politique (ajoutés en v1.1, révisés en v1.2 et v1.3)
...
Révision v1.2 : 2026-06-09
Révision v1.3 : 2026-06-09
